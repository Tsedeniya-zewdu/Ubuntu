...
South Africa</Typography> */}
        ...
        <div className="contact-form">
          <div className="form-top">
            <TextField className="form-name" label={t('contact:contact.3')} name="name" />
            <TextField
              className="form-email"
              label={t('contact:contact.4')}
              name="email"
            />
          </div>
          <TextField
            className="form-msg"
            label={t('contact:contact.5')}
            rows={6}
            multiline={true}
            name="msg"
          />
          <StyledButton variant='contained' className="contact-btn">{t('contact:contact.5')}</StyledButton>
        </div>
